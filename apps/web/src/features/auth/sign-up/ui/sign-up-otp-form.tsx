...
const SignUpOtpForm = ({ form, isPending, onSubmit, onBack }: SignUpOtpFormProps) => {
  return (
    <form onSubmit={onSubmit} className="flex flex-col gap-4 p-1">
      <div className="flex flex-col gap-1">
        <Label htmlFor="sign-up-otp-code">Verification code</Label>
        <Input id="sign-up-otp-code" placeholder="Enter 6-digit code" {...form.register('code')} />
